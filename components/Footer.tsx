...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-white/10 dark:bg-black/20 backdrop-blur-lg border-t border-white/20 dark:border-white/10 mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
            <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Dhaka College Cultural Club</p>
            </div>
            <div>
                <h3 className="font-bold text-gray-700 dark:text-gray-200 mb-2">Contact Us</h3>
