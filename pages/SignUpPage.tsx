...
const SignUpPage: React.FC = () => {
  ...
  return (
    <>
      <SEO 
        title="Sign Up | DCCC Shows"
        description="Create an account with the Dhaka College Cultural Club to start sharing your creative work and connect with fellow students."
        noIndex 
      />
